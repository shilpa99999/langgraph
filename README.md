...
LangGraph is inspired by [Pregel](https://research.google/pubs/pub37252/) and [Apache Beam](https://beam.apache.org/). The public interface draws inspiration from [NetworkX](https://networkx.org/documentation/latest/). LangGraph was originally built by LangChain Inc, the creators of LangChain, but can be used without LangChain. This project is currently maintained by Shilpa Kuppili.

## About the Maintainer

This project is actively maintained by Shilpa Kuppili, a Software Engineer with over 7 years of experience in developing scalable, enterprise-grade applications. Shilpa is proficient in Python, Java, and experienced in full-stack development, system design, and CI/CD pipelines.
