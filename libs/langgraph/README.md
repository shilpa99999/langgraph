...
LangGraph is inspired by [Pregel](https://research.google/pubs/pub37252/) and [Apache Beam](https://beam.apache.org/). The public interface draws inspiration from [NetworkX](https://networkx.org/documentation/latest/). LangGraph was originally developed by LangChain Inc, the creators of LangChain, and is currently maintained to ensure its continued evolution and support. It can be used without LangChain.

## About the Maintainer

This project is currently maintained by Shilpa Kuppili, a Software Engineer dedicated to ensuring its continued development and stability. With 7+ years of experience in software development, Shilpa brings expertise in building scalable applications, particularly with Python and Java, and a commitment to high-quality, maintainable code.
